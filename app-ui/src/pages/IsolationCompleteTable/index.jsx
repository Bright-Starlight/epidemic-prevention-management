...
class IsolationComplete extends React.Component {
    ...
    render() {
        ...
        const columns = [
            ...
            },
            {
                ...
                key: 'x',
                render: (text) => <div>
                    <UpdateIsolationComplete data={text} refresh={()=>{this.onChange(this.page,this.pageSize)}}/>
                    <br/>
                    <DeleteIsolationComplete  id={text.id} refresh={()=>{this.onChange(this.page,this.pageSize)}}/>
...
export default IsolationComplete;