...
function CreateIsolationComplete  (props)  {
    const [visible, setVisible] = useState(false);
    const refresh = props.refresh
    const [data, setData] = useState([]);
    const onCreate = (values) => {
        axios.post("http://localhost:3000/carrier/insertIsolationComplete", values).then(res => {
...
export default CreateIsolationComplete;